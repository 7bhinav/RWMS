...
export default function RegisterEmail(props: props) {
    ...
    return (
        <Html lang="en">
            <Head />
            <Preview>{type == "VERIFY_USER" ? "Welcome to RSWM - Simplifying your Waste Management" : "Lets recover your lost password"}</Preview>
            <Tailwind>
                <Html lang="en">
                    <Head>
                        <title>{type == "VERIFY_USER" ? "Welcome to RSWM " : "Lets recover your lost password"}</title>
                        <meta charSet="UTF-8" />
                    ...
                    <Body className=" bg-white text-black my-auto mx-auto font-sans">
                        <Container className="border border-solid  border-black/50 rounded my-[40px] mx-auto p-[20px] w-[465px]">
                            <Section className="mt-[32px]">
                                <Img src={"https://cdn.discordapp.com/attachments/1079039236302446705/1225206462054268938/wastelogo.png?ex=6620496f&is=660dd46f&hm=1a2848f6d8726100d22c2fe9431afee90fd9f621e310f65fc7e61266a2dfb109&"} width="100" height="100" alt="RSWM Logo" className="my-0 mx-auto" />
                            </Section>
                            ...
                            <Text className=" text-[14px] leading-[24px]">{type == "VERIFY_USER" ? "Welcome to RSWM, where we're revolutionizing waste management by making it fun and rewarding! We're excited to have you join our platform and become part of our waste-fighting community. \n" : "We hope this email finds you in good spirits! It seems like your password needs a little TLC, so we’ve set up a magic button just for you"}</Text>
