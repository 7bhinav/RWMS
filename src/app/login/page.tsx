...
const Page = () => {
    ...
    return (
        <>
            <section className="flex min-h-[88vh] justify-center items-center bg-white">
                <div className="border-black/10 border-2 shadow-lg shadow-black/10 w-full max-w-md mx-auto p-6 md:p-8 rounded-xl flex flex-col justify-center">
